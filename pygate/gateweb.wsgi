#!/usr/bin/env python
# gateweb.wsgi -- WSGI config for kegbot
...
#       # ...
#
#       WSGIDaemonProcess mygatebot
#       WSGIProcessGroup mygatebot
#       WSGIScriptAlias / /path/to/gateweb.wsgi
#
...
EXTRA_PATHS = [
    os.path.join(os.environ.get('HOME'), '.gatebot'),
    '/etc/gatebot',
]
...
os.environ['DJANGO_SETTINGS_MODULE'] = 'pygate.settings'
